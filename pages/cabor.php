    ...
    <div class="flex flex-col justify-between h-screen">
        ...
        <main>
            ...
            <div class="container mx-auto max-w-4xl my-20 px-4 sm:px-0">
                <div class="">
                    <h1 id="peserta" class=" text-4xl font-poppins font-bold text-slate-700">Cabang Olahraga</h1>
                    <p class="text-slate-500 mt-2">Cabang olahraga yang diperlombakan.</p>
                </div>
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
                    <table
                        class="w-full text-sm text-left rtl:text-right text-2xl border-collapse border-2 rounded-3xl bg-sky-50">
                        ...
                        <tbody class="text-slate-600">
                            ...
                            <?php 
                            $sql = "SELECT * FROM `cabang_olahraga` ";
